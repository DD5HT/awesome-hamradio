...
+ [inspectrum](https://github.com/miek/inspectrum) is a tool for analyzing captured signals, primarily from software-defined radio receivers.
...
+ [Wavelog](https://github.com/wavelog/wavelog) Enhanced power fork of Cloudlog. Stability, Usability, Performance. Web and Demo: [https://www.wavelog.org](https://www.wavelog.org).
...
+ [fcc-uls-cli](https://github.com/isquividet/fcc-uls-cli) Zero-dependency Python CLI and library that lists the FCC ULS daily change feed, parses its pipe-delimited licence and application records, and searches it for a call sign.
